...
router.get("/order", jwtCheck, jwtParse, restaurantControllers.getRestaurantOrders);

router.patch("/order/:orderId/status", jwtCheck, jwtParse, restaurantControllers.updateOrderStatus);
